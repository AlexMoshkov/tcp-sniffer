...
static const cyaml_schema_field_t save_in_template_fields_schema[] = {
        CYAML_FIELD_STRING_PTR("filepath", CYAML_FLAG_POINTER, struct save_in_template_handler, filepath, 0,
                               CYAML_UNLIMITED),
        CYAML_FIELD_STRING_PTR("template", CYAML_FLAG_POINTER, struct save_in_template_handler, template_str, 0,
                               CYAML_UNLIMITED),
        CYAML_FIELD_END
};
...
static const cyaml_schema_field_t handler_fields_schema[] = {
        ...
        CYAML_FIELD_MAPPING_PTR("save_in_template", CYAML_FLAG_POINTER | CYAML_FLAG_OPTIONAL, struct cfg_handler,
                                save_in_template, save_in_template_fields_schema),
        CYAML_FIELD_END
};
